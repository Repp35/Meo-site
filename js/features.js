...
let favs=new Set();
function toggleFav(id){const btn=document.getElementById('fav-'+id);if(!btn)return;if(favs.has(id)){favs.delete(id);btn.classList.remove('active');}else{favs.add(id);btn.classList.add('active');}}
